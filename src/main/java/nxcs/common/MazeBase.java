...
//                            }
                            ...
                            if (this.isEndOfProblem(this.getState())) {
                                statLogger.fatal(String.format("%d,%d,%d,%d,%d,%d,%d,%d", this.finalStateCount, nxcs.c1, nxcs.c2, nxcs.c3, nxcs.c4, nxcs.c5, nxcs.c6, nxcs.population.size()));
                                this.resetPosition();
                                finalStateCount++;
...
//                                        this.np.obj1[obj_num], trailIndex, this.np.N));
                        ...
                        logger.info(String.format("NXCS:c1=%d, c2=%d, c3=%d, c4=%d, c5=%d, c6=%d", nxcs.c1, nxcs.c2, nxcs.c3, nxcs.c4,nxcs.c5, nxcs.c6));
